...
// g++ -std=c++20 -O3 -lrt xfce-hkmon.cpp -o xfce-hkmon (gcc >= 4.6 or clang++)
...
bool readFile(const char* inputFile, std::vector<char>& buffer, bool mustExist)
{
